...
public class Resp {
     ...
     * @throws IOException
     */
    public static Navigation redirectLoginForm(HttpServletRequest req,
     ...
     * @throws IOException
     */
    public static void responseHtml(HttpServletResponse resp)
            throws IOException {
    ...
    public static void responseErrorJson(HttpServletResponse resp, String json)
            throws IOException {
        resp.setContentType(CONTENT_TYPE_JSON);
        resp.setCharacterEncoding(CHAR_ENCODE_UTF_8);
